...
function Grid() {
    ...
    Rolls.forEach(eachRoll => { // loop on all the Roll's
        ...
        // Add dropdown options
        // Add pack size radio buttons
        const {glazingElement, packSizeElement} = ItemOptions(eachRoll);
        
        // console.log(process.env.PUBLIC_URL + eachRoll.imgSrc);
        gridContent.push(
            <div className="grid-item" id={eachRoll.elementID}>
                <img src={process.env.PUBLIC_URL + eachRoll.imgSrc} alt={eachRoll.type}/>
